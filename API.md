...
| <code><a href="#cdk-bootstrap-cleanup.BootstrapCleanup.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="cdk-bootstrap-cleanup.BootstrapCleanup.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="cdk-bootstrap-cleanup.BootstrapCleanup.with.parameter.mixins"></a>
